package com.yatu.electronicCigarettesShop.controller;
...
import com.yatu.electronicCigarettesShop.validator.ProductInfoValidator;
...
public class AdminController {
    ...
    public String product(Model model, @RequestParam(value = "id", defaultValue = "0") int id) {
